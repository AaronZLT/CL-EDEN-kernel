...
/**
 * @file    ConvolutionWINO6x6_3x3Kernels.cpp
 * @brief
 * @details
 * @version
 */
...
#define WINO6X6_WEIGHT_TM_NCHW_OPT_4X16(wt, wt_tm, outch, inch, aligned_outch, aligned_inch, aligned_pixel) \
      ...
      { \
        ...
        int src_base = (outc * inch + inc) * 9; \
        DATA_T8 src_w0_7 = vload8(0, wt + src_base); \
        DATA_T src_w8 = wt[src_base + 8]; \
        DATA_T tmp_r0[3]; \
        DATA_T tmp_r1[3]; \
        DATA_T tmp_r2[3]; \
        DATA_T tmp_r3[3]; \
        ...
        DATA_T tmp_r6[3]; \
        DATA_T tmp_r7[3]; \
        tmp_r0[0] = src_w0_7.s0; \
        tmp_r0[1] = src_w0_7.s1; \
        tmp_r0[2] = src_w0_7.s2; \
        tmp_r1[0] = src_w0_7.s0 + 0.707107f * src_w0_7.s3 + 0.5f * src_w0_7.s6; \
        tmp_r1[1] = src_w0_7.s1 + 0.707107f * src_w0_7.s4 + 0.5f * src_w0_7.s7; \
        tmp_r1[2] = src_w0_7.s2 + 0.707107f * src_w0_7.s5 + 0.5f * src_w8; \
        tmp_r2[0] = src_w0_7.s0 - 0.707107f * src_w0_7.s3 + 0.5f * src_w0_7.s6; \
        tmp_r2[1] = src_w0_7.s1 - 0.707107f * src_w0_7.s4 + 0.5f * src_w0_7.s7; \
        tmp_r2[2] = src_w0_7.s2 - 0.707107f * src_w0_7.s5 + 0.5f * src_w8; \
        tmp_r3[0] = src_w0_7.s0 + 1.414214f * src_w0_7.s3 + 2.0f * src_w0_7.s6; \
        tmp_r3[1] = src_w0_7.s1 + 1.414214f * src_w0_7.s4 + 2.0f * src_w0_7.s7; \
        tmp_r3[2] = src_w0_7.s2 + 1.414214f * src_w0_7.s5 + 2.0f * src_w8; \
        tmp_r4[0] = src_w0_7.s0 - 1.414214f * src_w0_7.s3 + 2.0f * src_w0_7.s6; \
        tmp_r4[1] = src_w0_7.s1 - 1.414214f * src_w0_7.s4 + 2.0f * src_w0_7.s7; \
        tmp_r4[2] = src_w0_7.s2 - 1.414214f * src_w0_7.s5 + 2.0f * src_w8; \
        tmp_r5[0] = src_w0_7.s0 + 2.121320f * src_w0_7.s3 + 4.5f * src_w0_7.s6; \
        tmp_r5[1] = src_w0_7.s1 + 2.121320f * src_w0_7.s4 + 4.5f * src_w0_7.s7; \
        tmp_r5[2] = src_w0_7.s2 + 2.121320f * src_w0_7.s5 + 4.5f * src_w8; \
        tmp_r6[0] = src_w0_7.s0 - 2.121320f * src_w0_7.s3 + 4.5f * src_w0_7.s6; \
        tmp_r6[1] = src_w0_7.s1 - 2.121320f * src_w0_7.s4 + 4.5f * src_w0_7.s7; \
        tmp_r6[2] = src_w0_7.s2 - 2.121320f * src_w0_7.s5 + 4.5f * src_w8; \
        tmp_r7[0] = src_w0_7.s6; \
        tmp_r7[1] = src_w0_7.s7; \
        tmp_r7[2] = src_w8; \
        DATA_T dst_r0[8]; \
        DATA_T dst_r1[8]; \
        DATA_T dst_r2[8]; \
...
#define WINO6X6_INPUT_TM_NCHW_OPT_4X16(src_data, dst_data, src_n, src_c, src_h, src_w, dst_n, dst_c, dst_h, dst_w, \
      ...
      int in_w_start = w_index * 6 - padL; \
      int in_h_start = h_index * 6 - padT; \
      ...
      if (in_h_start >= 0 && in_h_start < src_h) { \
          row0 = vload16(0, src_data + in_base); \
      } \
      if (in_h_start + 1 >= 0 && in_h_start + 1 < src_h) { \
          row1 = vload16(0, src_data + in_base + src_w); \
      } \
      ...
      if (in_w_start + 12 < 0 || in_w_start + 12 >= src_w) { \
          inputMask.sC = 0x0000; \
      } \
      if (in_w_start + 13 < 0 || in_w_start + 13 >= src_w) { \
          inputMask.sD = 0x0000; \
      } \
      inputMask.sE = 0x0000; \
      inputMask.sF = 0x0000; \
      ...
      DATA_T bt = bt_ar[0]; \
      DATA_T2 src0 = (DATA_T2)(row0.s0, row0.s6); \
      I0 = bt * src0; \
      DATA_T2 src1 = (DATA_T2)(row0.s1, row0.s7); \
      I1 = bt * src1; \
      DATA_T2 src2 = (DATA_T2)(row0.s2, row0.s8); \
      I2 = bt * src2; \
      DATA_T2 src3 = (DATA_T2)(row0.s3, row0.s9); \
      I3 = bt * src3; \
      DATA_T2 src4 = (DATA_T2)(row0.s4, row0.sA); \
      I4 = bt * src4; \
      DATA_T2 src5 = (DATA_T2)(row0.s5, row0.sB); \
      I5 = bt * src5; \
      DATA_T2 src6 = (DATA_T2)(row0.s6, row0.sC); \
      I6 = bt * src6; \
      DATA_T2 src7 = (DATA_T2)(row0.s7, row0.sD); \
      I7 = bt * src7; \
      bt = bt_ar[1]; \
      src0 = (DATA_T2)(row1.s0, row1.s6); \
      I0 += bt * src0; \
      src1 = (DATA_T2)(row1.s1, row1.s7); \
      I1 += bt * src1; \
      src2 = (DATA_T2)(row1.s2, row1.s8); \
      I2 += bt * src2; \
      src3 = (DATA_T2)(row1.s3, row1.s9); \
      I3 += bt * src3; \
      src4 = (DATA_T2)(row1.s4, row1.sA); \
      I4 += bt * src4; \
      src5 = (DATA_T2)(row1.s5, row1.sB); \
      I5 += bt * src5; \
      src6 = (DATA_T2)(row1.s6, row1.sC); \
      I6 += bt * src6; \
      src7 = (DATA_T2)(row1.s7, row1.sD); \
      I7 += bt * src7; \
      bt = bt_br[0]; \
      src0 = (DATA_T2)(row0.s0, row0.s6); \
      J0 = bt * src0; \
      src1 = (DATA_T2)(row0.s1, row0.s7); \
      J1 = bt * src1; \
      src2 = (DATA_T2)(row0.s2, row0.s8); \
      J2 = bt * src2; \
      src3 = (DATA_T2)(row0.s3, row0.s9); \
      J3 = bt * src3; \
      src4 = (DATA_T2)(row0.s4, row0.sA); \
      J4 = bt * src4; \
      src5 = (DATA_T2)(row0.s5, row0.sB); \
      J5 = bt * src5; \
      src6 = (DATA_T2)(row0.s6, row0.sC); \
      J6 = bt * src6; \
      src7 = (DATA_T2)(row0.s7, row0.sD); \
      J7 = bt * src7; \
      bt = bt_br[1]; \
      src0 = (DATA_T2)(row1.s0, row1.s6); \
      J0 += bt * src0; \
      ...
      if (in_h_start + 2 >= 0 && in_h_start + 2 < src_h) { \
          row0 = vload16(0, src_data + in_base + src_w * 2); \
      } \
      if (in_h_start + 3 >= 0 && in_h_start + 3  < src_h) { \
          row1 = vload16(0, src_data + in_base + src_w * 3); \
      } \
      row0 = AS_DATA_T16(as_short16(row0) & inputMask); \
      row1 = AS_DATA_T16(as_short16(row1) & inputMask); \
      bt = bt_ar[2]; \
      ...
      if (in_h_start + 4 >= 0 && in_h_start + 4 < src_h) { \
          row0 = vload16(0, src_data + in_base + src_w * 4); \
      } \
      if (in_h_start + 5 >= 0 && in_h_start + 5 < src_h) { \
          row1 = vload16(0, src_data + in_base + src_w * 5); \
      } \
      row0 = AS_DATA_T16(as_short16(row0) & inputMask); \
      row1 = AS_DATA_T16(as_short16(row1) & inputMask); \
      bt = bt_ar[4]; \
      ...
      if (in_h_start + 6 >= 0 && in_h_start + 6 < src_h) { \
          row0 = vload16(0, src_data + in_base + src_w * 6); \
      } \
      if (in_h_start + 7 >= 0 && in_h_start + 7 < src_h) { \
          row1 = vload16(0, src_data + in_base + src_w * 7); \
      } \
      row0 = AS_DATA_T16(as_short16(row0) & inputMask); \
      row1 = AS_DATA_T16(as_short16(row1) & inputMask); \
      bt = bt_ar[6]; \
...
#define WINO6X6_DOT_MULTIPLY_NCHW_OPT_4X16(input_tm, weight_tm, dot_result, dst_n, dst_c, dst_h, dst_w, input_c, \
...
#define WINO6X6_OUTPUT_TM_NCHW_OPT_4X16(dot_result, bias, output, src_n, src_c, src_h, src_w, output_n, output_c, \
      ...
      int tile_totals = ((output_h + 5) / 6) * tile_x; \
      if (c_index >= output_c || t_index >= tile_totals || \
          h_index * 6 + p_index >= output_h || w_index * 6 >= output_w) { \
        return; \
      } \
      DATA_T at_ar[8]; \
      DATA_T8 t00 = vload8(0, At8x8 + 8 * p_index); \
      at_ar[0] = t00.s0; \
      at_ar[1] = t00.s1; \
      at_ar[2] = t00.s2; \
      at_ar[3] = t00.s3; \
      ...
      dst_base += (h_index * 6 + p_index) * output_w + w_index * 6; \
      DATA_T16 ping; \
      ...
      if (w_index * 6 + 11 < output_w) { \
        DATA_T2 f0 = CONVERT_TO_DATA_T2(tmp0 + t0 + t1 + t2) + bias_val; \
        DATA_T2 f1 = CONVERT_TO_DATA_T2(t3 * At8x8[9] + t4 * At8x8[11] + t5 * At8x8[13]) + bias_val; \
        DATA_T2 f2 = CONVERT_TO_DATA_T2(t0 * At8x8[17] + t1 * At8x8[19] + t2 * At8x8[21]) + bias_val; \
        DATA_T2 f3 = CONVERT_TO_DATA_T2(t3 * At8x8[25] + t4 * At8x8[27] + t5 * At8x8[29]) + bias_val; \
        DATA_T2 f4 = CONVERT_TO_DATA_T2(t0 * At8x8[33] + t1 * At8x8[35] + t2 * At8x8[37]) + bias_val; \
        DATA_T2 f5 = CONVERT_TO_DATA_T2(t3 * At8x8[41] + t4 * At8x8[43] + t5 * At8x8[45] + tmp7) + bias_val; \
        f0 = ACT_VEC_F(DATA_T2, f0); \
        f1 = ACT_VEC_F(DATA_T2, f1); \
        f2 = ACT_VEC_F(DATA_T2, f2); \
        f3 = ACT_VEC_F(DATA_T2, f3); \
        f4 = ACT_VEC_F(DATA_T2, f4); \
        f5 = ACT_VEC_F(DATA_T2, f5); \
        vstore8((DATA_T8)(f0.s0, f1.s0, f2.s0, f3.s0, f4.s0, f5.s0, f0.s1, f1.s1), 0, output + dst_base); \
        vstore4((DATA_T4)(f2.s1, f3.s1, f4.s1, f5.s1), 0, output + dst_base + 8); \
      } else { \
        if ((w_index * 6 + 0) < output_w) { \
            DATA_T2 f0 = CONVERT_TO_DATA_T2(tmp0 + t0 + t1 + t2) + bias_val; \
            f0 = ACT_VEC_F(DATA_T2, f0); \
            output[dst_base] = f0.s0; \
            if (w_index * 6 + 6 < output_w)  output[dst_base + 6] = f0.s1; \
        } \
        if ((w_index * 6 + 1) < output_w) { \
          DATA_T2 f1 = CONVERT_TO_DATA_T2(t3 * At8x8[9] + t4 * At8x8[11] + t5 * At8x8[13]) + bias_val; \
          f1 = ACT_VEC_F(DATA_T2, f1); \
          dst_base += 1; \
          output[dst_base] = f1.s0; \
          if (w_index * 6 + 7 < output_w) output[dst_base + 6] = f1.s1; \
        } \
        if ((w_index * 6 + 2) < output_w) { \
          DATA_T2 f2 = CONVERT_TO_DATA_T2(t0 * At8x8[17] + t1 * At8x8[19] + t2 * At8x8[21]) + bias_val; \
          f2 = ACT_VEC_F(DATA_T2, f2); \
          dst_base += 1; \
          output[dst_base] = f2.s0; \
          if (w_index * 6 + 8 < output_w) output[dst_base + 6] = f2.s1; \
        } \
        if ((w_index * 6 + 3) < output_w) { \
          DATA_T2 f3 = CONVERT_TO_DATA_T2(t3 * At8x8[25] + t4 * At8x8[27] + t5 * At8x8[29]) + bias_val; \
          f3 = ACT_VEC_F(DATA_T2, f3); \
          dst_base += 1; \
          output[dst_base] = f3.s0; \
          if (w_index * 6 + 9 < output_w) output[dst_base + 6] = f3.s1; \
        } \
        if ((w_index * 6 + 4) < output_w) { \
          DATA_T2 f4 = CONVERT_TO_DATA_T2(t0 * At8x8[33] + t1 * At8x8[35] + t2 * At8x8[37]) + bias_val; \
          f4 = ACT_VEC_F(DATA_T2, f4); \
          dst_base += 1; \
          output[dst_base] = f4.s0; \
          if (w_index * 6 + 10 < output_w) output[dst_base + 6] = f4.s1; \
        } \
        if ((w_index * 6 + 5) < output_w) { \
          DATA_T2 f5 = CONVERT_TO_DATA_T2(t3 * At8x8[41] + t4 * At8x8[43] + t5 * At8x8[45] + tmp7) + bias_val; \
          f5 = ACT_VEC_F(DATA_T2, f5); \
          dst_base += 1; \
          output[dst_base] = f5.s0; \
          if (w_index * 6 + 11 < output_w) output[dst_base + 6] = f5.s1; \
        } \
      }
...
ADD_SINGLE_KERNEL(wino6x6_weight_tm_nchw_opt_4x16_FP16, (__global half *wt,
                                              __global half *wt_tm, int outch,
                                              int inch, int aligned_outch, int aligned_inch, int aligned_pixel) {
    WINO6X6_WEIGHT_TM_NCHW_OPT_4X16(wt, wt_tm, outch, inch, aligned_outch, aligned_inch, aligned_pixel)
})

ADD_KERNEL_HEADER(wino6x6_input_tm_nchw_opt_4x16_FP16, {DEFINE_BT8X8})
ADD_SINGLE_KERNEL(wino6x6_input_tm_nchw_opt_4x16_FP16, (
    ...
    WINO6X6_INPUT_TM_NCHW_OPT_4X16(src_data, dst_data, src_n, src_c, src_h, src_w, dst_n, dst_c, dst_h, dst_w, padL, \
                                   padT, tiles_total, coalescing_feature_height_, tiles_x, aligned_inch, aligned_pixel)
})

ADD_SINGLE_KERNEL(wino6x6_dot_multiply_nchw_opt_4x16_FP16, (
    ...
    WINO6X6_DOT_MULTIPLY_NCHW_OPT_4X16(input_tm, weight_tm, dot_result, dst_n, dst_c, dst_h, dst_w, input_c, \
                                       output_c, coalescing_feature_height_, aligned_outch, aligned_inch, aligned_pixel)
})


// kernels without activation func
#define ACT_VEC_F(VEC_T, x) x
ADD_KERNEL_HEADER(wino6x6_output_tm_nchw_opt_4x16_FP16, {DEFINE_AT8X8})
ADD_SINGLE_KERNEL(wino6x6_output_tm_nchw_opt_4x16_FP16, (
    ...
    WINO6X6_OUTPUT_TM_NCHW_OPT_4X16(dot_result, bias, output, src_n, src_c, src_h, src_w, output_n, output_c, \
                                    output_h, output_w, coalescing_feature_height_, tile_x, aligned_outch, \
                                    aligned_inch, aligned_pixel)
})
...
ADD_KERNEL_HEADER(RELUwino6x6_output_tm_nchw_opt_4x16_FP16, {DEFINE_AT8X8})
ADD_SINGLE_KERNEL(RELUwino6x6_output_tm_nchw_opt_4x16_FP16, (
        __global half *dot_result, __global half *bias, __global half *output,
        int src_n, int src_c, int src_h, int src_w, int output_n, int output_c,
        int output_h, int output_w, int coalescing_feature_height_,
        int tile_x, int aligned_outch, int aligned_inch, int aligned_pixel) {
...
ADD_KERNEL_HEADER(RELU6wino6x6_output_tm_nchw_opt_4x16_FP16, {DEFINE_AT8X8})
ADD_SINGLE_KERNEL(RELU6wino6x6_output_tm_nchw_opt_4x16_FP16, (
        __global half *dot_result, __global half *bias, __global half *output,
        int src_n, int src_c, int src_h, int src_w, int output_n, int output_c,
        int output_h, int output_w, int coalescing_feature_height_,
        int tile_x, int aligned_outch, int aligned_inch, int aligned_pixel) {
