 ...
 *
 * @param info_id    type of information (please ref to enum EnnInfoId)
 * @param output_str string output
 * @return EnnReturn   zero if successful
 */
extern EnnReturn EnnGetModelInfo(EnnInfoId info_id, char* output_str[ENN_INFO_GRAPH_STR_LENGTH_MAX]);
