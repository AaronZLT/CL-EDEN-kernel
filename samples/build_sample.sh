...
cd $ANDROID_TOP/vendor/samsung_slsi/exynos/enn/source/samples
mm -j16
mv Android.bp Android.bp.sample

#adb shell setprop dbg.property.for.exynos.nn 0xFFFFFFFF   // file out
#adb shell "cd /data/raw/; enn_sample_thumbnail"
