...
struct GatherParameters : public Parameters {
    int32_t axis = 0;
...
class CLGather {
public:
    CLGather(const std::shared_ptr<CLRuntime> runtime, const PrecisionType &precision);
...
private:
    ...
    std::shared_ptr<CLTensor> indices_tensor_;
