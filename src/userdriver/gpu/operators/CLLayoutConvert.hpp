...
struct LayoutConvertParameters : public Parameters {
    DataOrderChangeType data_order_change_type;
};

class CLLayoutConvert {
  public:
    CLLayoutConvert(const std::shared_ptr<CLRuntime> runtime, const PrecisionType &precision);
  ...
  private:
    ...
    std::shared_ptr<LayoutConvertParameters> parameters_;
};
